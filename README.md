...
- XSD validation for the XML format
- better reporting of validation errors
- stronger consistency checks for transitions
- automated tests for XML import/export
- versioning support for configuration files
